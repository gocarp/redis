...
// GroupSortedSetInterface manages redis sorted set operations.
// Implements see redis.GroupSortedSet.
type GroupSortedSetInterface interface {
	ZAdd(ctx context.Context, key string, option *ZAddOption, member ZAddMember, members ...ZAddMember) (*vars.Var, error)
	...
	ZRange(ctx context.Context, key string, start, stop int64, option ...ZRangeOption) (vars.Vars, error)
	ZRevRange(ctx context.Context, key string, start, stop int64, option ...ZRevRangeOption) (*vars.Var, error)
