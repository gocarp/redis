...
// GroupGenericInterface manages generic redis operations.
// Implements see redis.GroupGeneric.
type GroupGenericInterface interface {
	...
	ExpireTime(ctx context.Context, key string) (*vars.Var, error)
	...
	PExpireTime(ctx context.Context, key string) (*vars.Var, error)
